...
import ProductScreen from './TimeKeeper/TimeKeeperScreens/ProductScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://bold-link-node.site/`;
  const URL_IDENTIFAIRE = `Pw5kSu83`;
  ...
  OneSignal.initialize('aa17862b-eb1f-437e-90ea-fdb903ad23a7');
